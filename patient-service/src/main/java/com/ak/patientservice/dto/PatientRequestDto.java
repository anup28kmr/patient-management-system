package com.ak.patientservice.dto;
...
public class PatientRequestDto {
  ...
  public @NotBlank(message = "Name is required") @Size(min = 2, max = 100, message = "Name cannot exceed 100 characters") String getName() {
    return name;
  }

  public void setName(@NotBlank(message = "Name is required") @Size(min = 2, max = 100, message = "Name cannot exceed 100 characters") String name) {
    this.name = name;
  }
